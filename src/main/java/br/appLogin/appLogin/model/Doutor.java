...
public class Doutor {
    ...
    private String ultimasAvaliacoes;
    ...
    public void setAvaliacoes(List<Avaliacao> avaliacoes) {
        ...
        public String getUltimasAvaliacoes() {
        return ultimasAvaliacoes; // Certifique-se de que há um getter público
    }

    public void setUltimasAvaliacoes(String ultimasAvaliacoes) {
